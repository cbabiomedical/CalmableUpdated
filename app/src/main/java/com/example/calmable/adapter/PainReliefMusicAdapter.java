...
public class PainReliefMusicAdapter extends RecyclerView.Adapter<PainReliefMusicAdapter.ViewHolder> {
    ...
    public PainReliefMusicAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public PainReliefMusicAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PainReliefMusicAdapter.ViewHolder holder, int position) {
