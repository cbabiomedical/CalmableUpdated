...
public class SelfImprovementAdapter extends RecyclerView.Adapter<SelfImprovementAdapter.ViewHolder> {
    ...
    public SelfImprovementAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public SelfImprovementAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SelfImprovementAdapter.ViewHolder holder, int position) {
