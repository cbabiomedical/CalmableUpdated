...
public class InstrumentalMusicAdapter extends RecyclerView.Adapter<InstrumentalMusicAdapter.ViewHolder> {
    ...
    public InstrumentalMusicAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public InstrumentalMusicAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull InstrumentalMusicAdapter.ViewHolder holder, int position) {
