...
public class MeditateMusicAdapter extends RecyclerView.Adapter<MeditateMusicAdapter.ViewHolder>  {
    ...
    public MeditateMusicAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public MeditateMusicAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MeditateMusicAdapter.ViewHolder holder, int position) {
