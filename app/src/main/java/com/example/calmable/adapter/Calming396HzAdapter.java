...
public class Calming396HzAdapter extends RecyclerView.Adapter<Calming396HzAdapter.ViewHolder> {
    ...
    public Calming396HzAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public Calming396HzAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Calming396HzAdapter.ViewHolder holder, int position) {
    ...
    private void readCursorDataDP(FavModel coffeeItem, Calming396HzAdapter.ViewHolder viewHolder) {
