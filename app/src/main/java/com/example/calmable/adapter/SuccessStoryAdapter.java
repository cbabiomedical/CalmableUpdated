...
public class SuccessStoryAdapter extends RecyclerView.Adapter<SuccessStoryAdapter.ViewHolder> {
    ...
    private FavDB favDB;
    public static DeepRelaxMusicAdapter.ViewHolder viewHolder;

    public static DeepRelaxMusicAdapter.ViewHolder getViewHolder() {
        return viewHolder;
    }

    public static void setViewHolder(DeepRelaxMusicAdapter.ViewHolder viewHolder) {
        SuccessStoryAdapter.viewHolder = viewHolder;
    }

    public SuccessStoryAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public SuccessStoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SuccessStoryAdapter.ViewHolder holder, int position) {
