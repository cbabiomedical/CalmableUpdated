...
public class LoveMusicAdapter extends RecyclerView.Adapter<LoveMusicAdapter.ViewHolder> {
    ...
    public LoveMusicAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public LoveMusicAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LoveMusicAdapter.ViewHolder holder, int position) {
