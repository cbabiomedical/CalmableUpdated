...
import com.example.calmable.CreativityActivity;
...
public class CreativityAdapter extends RecyclerView.Adapter<CreativityAdapter.ViewHolder> {
    ...
    public CreativityAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public CreativityAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CreativityAdapter.ViewHolder holder, int position) {
