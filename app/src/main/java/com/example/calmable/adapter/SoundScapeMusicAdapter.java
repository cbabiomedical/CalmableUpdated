...
public class SoundScapeMusicAdapter extends RecyclerView.Adapter<SoundScapeMusicAdapter.ViewHolder> {
    ...
    public SoundScapeMusicAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public SoundScapeMusicAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SoundScapeMusicAdapter.ViewHolder holder, int position) {
