...
public class NatureSoundsAdapter extends RecyclerView.Adapter<NatureSoundsAdapter.ViewHolder> {
    ...
    public NatureSoundsAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public NatureSoundsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NatureSoundsAdapter.ViewHolder holder, int position) {
