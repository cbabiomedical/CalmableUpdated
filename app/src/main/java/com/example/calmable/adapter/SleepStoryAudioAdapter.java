...
public class SleepStoryAudioAdapter extends RecyclerView.Adapter<SleepStoryAudioAdapter.ViewHolder>{
    ...
    public SleepStoryAudioAdapter(ArrayList<FavModel> listOfSongs, Context context) {
    ...
    @NonNull
    @Override
    public SleepStoryAudioAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SleepStoryAudioAdapter.ViewHolder holder, int position) {
