...
public class SleepRate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sleep_rate);
        ...
        ratingStars.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(SleepRate.this, message, Toast.LENGTH_SHORT).show();
            }
        });
...
// the very first time when the app is opened, there is nothing to show
        ...
        ratingBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(SleepRate.this,String.valueOf(myRating), Toast.LENGTH_SHORT).show();
