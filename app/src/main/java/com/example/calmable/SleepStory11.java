...
public class SleepStory11 extends AppCompatActivity {
    Button ratingbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sleep_story11);
    ...
    public void btnTheme (View view){
        startActivity(new Intent(getApplicationContext(), Sleep11DarkTheme.class));
    }
