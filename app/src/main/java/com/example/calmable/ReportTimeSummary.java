...
public class ReportTimeSummary extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_time_summary);
...
//                                                                        }
    ...
    private void openDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(ReportTimeSummary.this);
